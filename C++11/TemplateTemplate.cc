...
public :
   Derived (T1 * arg1, T2 * arg2) : Base<T1>(arg1) {
...
int main(int argc, char * argv[]) {
    ...
    Derived<char, char> obj1("pallav1", "puneet1");
    Derived<char, char> obj2("pallav2", "puneet2");
    Derived<char, char> obj3(obj2);
    obj3 = obj1;
#endif 

#if 1
    // Here we Check for Move Const and Move Assignment Operator
    Derived<char, char> obj11("pallav1", "puneet1");
    Derived<char, char> obj22("pallav2", "puneet2");
    Derived<char, char> obj33(move(obj22));
    obj33 = move(obj11);
#endif 
